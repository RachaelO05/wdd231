...
function displayCourses(courses) {
    ...
    courses.forEach((course) => {
        ...
        if (course.completed) {
            courseP.classList.add("completed");
        };
...
function displayCredits(totalCredit) {
...
allBtn.addEventListener('click', () => {
    ...
    totalCredit = courses.reduce((total, course) => {
...
wddBtn.addEventListener('click', () => {
    ...
    totalCredit = wddCourses.reduce((total, course) => {
        return total + course.credits;
    } ,0);
    displayCredits(totalCredit);
});
...
cseBtn.addEventListener('click', () => {
    ...
    totalCredit = cseCourses.reduce((total, course) => {
        return total + course.credits;
    } ,0);
    displayCredits(totalCredit);
});